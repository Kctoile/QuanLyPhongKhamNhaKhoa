...
public class AppointmentAdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<com.dentalclinic.model.Appointment> appointments = dao.getAll();
        for (com.dentalclinic.model.Appointment appointment : appointments) {
            appointment.setPayment(paymentDAO.getByAppointmentId(appointment.getAppointmentId()));
        }
        request.setAttribute("list", appointments);
