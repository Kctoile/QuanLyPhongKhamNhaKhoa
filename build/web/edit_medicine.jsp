    ...
    <%@ include file="admin_menu.jsp" %>
        ...
        <div style="margin-left: 240px; padding: 20px;">
            ...
            <form action="medicines" method="post" style="max-width: 500px;">
                ...
                <input type="hidden" name="medicineId" value="${param.id}">

                <div style="margin-bottom: 15px;">
                    <label style="display:block; font-weight:bold; margin-bottom:5px;">Tên thuốc *</label>
                    <input type="text" name="medicineName" value="${param.name}" required
                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <input type="number" name="stockQuantity" value="${param.stock}" required
